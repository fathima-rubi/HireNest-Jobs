  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: StreamBuilder(
          stream: education.where('addedBy',isEqualTo: addedBy).snapshots(),
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                IconButton(
                                  onPressed: () {
                                    Navigator.pushNamed(context, 'education_edit',arguments: {
                                      'academicCredential' :snap['academicCredential'],
                                      'fieldOfStudy' :snap['fieldOfStudy'],
                                      'institution' :snap['institution'],
